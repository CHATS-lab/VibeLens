...
- Read [`docs/spec/parsers/add-parser-skill.md`](docs/spec/parsers/add-parser-skill.md) end-to-end before writing code.
- Each existing parser's per-format specifics live in `docs/spec/parsers/<agent>.md`.
- The comparison matrix is [README.md](docs/spec/parsers/README.md).
