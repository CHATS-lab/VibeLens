      ...
      {visible && text &&
        createPortal(
          <span
            ...
            className="z-[9999] px-3 py-2 text-xs leading-relaxed text-primary bg-control/95 border border-hover rounded-lg shadow-2xl max-w-[300px] w-max text-center pointer-events-none break-words"
          >
            {text}
          </span>,
          document.body,
